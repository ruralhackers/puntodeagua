...
import { CreateAnalysisCmd } from './features/(private)/analysis/application/create-analysis.cmd'
import { DeleteAnalysisCmd } from './features/(private)/analysis/application/delete-analysis.cmd'
import { EditAnalysisCmd } from './features/(private)/analysis/application/edit-analysis.cmd'
import { GetAnalysesQry } from './features/(private)/analysis/application/get-analyses.qry'
import { GetAnalysisQry } from './features/(private)/analysis/application/get-analysis.qry'
import { AnalysisPrismaRepository } from './features/(private)/analysis/infrastructure/analysis.prisma-repository'
import { AuthenticateUserCmd } from './features/(public)/auth/application/authenticate-user.cmd'
import { UserPrismaRepository } from './features/(public)/auth/infrastructure/user.prisma-repository'
import { CreateHolderCmd } from './features/(private)/holder/application/create-holder.cmd'
import { DeleteHolderCmd } from './features/(private)/holder/application/delete-holder.cmd'
import { EditHolderCmd } from './features/(private)/holder/application/edit-holder.cmd'
import { GetHolderQry } from './features/(private)/holder/application/get-holder.qry'
import { GetHoldersQry } from './features/(private)/holder/application/get-holders.qry'
import { HolderPrismaRepository } from './features/(private)/holder/infrastructure/holder.prisma-repository'
import { EditIssueCmd } from './features/(private)/issue/application/edit-issue.cmd'
import { GetIssueByIdQry } from './features/(private)/issue/application/get-issue-by-id.qry'
import { GetIssuesQry } from './features/(private)/issue/application/get-issues.qry'
import { SaveIssueCmd } from './features/(private)/issue/application/save-issue.cmd'
import { IssuePrismaRepository } from './features/(private)/issue/infrastructure/issue.prisma-repository'
import { GetMaintenanceQry } from './features/(private)/maintenance/application/get-maintenance.qry'
import { GetMaintenancesQry } from './features/(private)/maintenance/application/get-maintenances.qry'
import { SaveMaintenanceCmd } from './features/(private)/maintenance/application/save-maintenance.cmd'
import { MaintenancePrismaRepository } from './features/(private)/maintenance/infrastructure/maintenance.prisma-repository'
import { GetSummaryQry } from './features/(public)/summary/application/get-summary.qry'
import { CreateUserCmd } from './features/(private)/user/application/create-user.cmd'
import { DeleteUserCmd } from './features/(private)/user/application/delete-user.cmd'
import { GetUsersQry } from './features/(private)/user/application/get-users.qry'
import { GetWaterMeterQry } from './features/(private)/water-meter/application/get-water-meter.qry'
import { GetWaterMetersQry } from './features/(private)/water-meter/application/get-water-meters.qry'
import { WaterMeterPrismaRepository } from './features/(private)/water-meter/infrastructure/water-meter.prisma-repository'
import { CreateWaterMeterReadingCmd } from './features/(private)/water-meter-reading/application/create-water-meter-reading.cmd'
import { DeleteWaterMeterReadingCmd } from './features/(private)/water-meter-reading/application/delete-water-meter-reading.cmd'
import { GetWaterMeterReadingsQry } from './features/(private)/water-meter-reading/application/get-water-meter-readings.qry'
import { WaterMeterReadingPrismaRepository } from './features/(private)/water-meter-reading/infrastructure/water-meter-reading.prisma-repository'
import { CreateWaterPointCmd } from './features/(private)/water-point/application/create-water-point.cmd'
import { DeleteWaterPointCmd } from './features/(private)/water-point/application/delete-water-point.cmd'
import { EditWaterPointCmd } from './features/(private)/water-point/application/edit-water-point.cmd'
import { GetWaterPointQry } from './features/(private)/water-point/application/get-water-point.qry'
import { GetWaterPointsQry } from './features/(private)/water-point/application/get-water-points.qry'
import { WaterPointPrismaRepository } from './features/(private)/water-point/infrastructure/water-point.prisma-repository'
import { GetWaterZonesQry } from './features/(private)/water-zone/application/get-water-zones.qry'
import { WaterZonePrismaRepository } from './features/(private)/water-zone/infrastructure/water-zone.prisma-repository'
