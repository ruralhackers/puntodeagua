	...
	useEffect(() => {
		...
		const cargarIncidencia = async () => {
			...
			const incidenciaEjemplo = {
				...
				puntoAgua: "pozo-a",
				descripcion:
					"Se detectó una fuga significativa en la tubería principal que abastece al sector norte.",
			...
			<form onSubmit={handleSubmit} className="space-y-4">
				...
				<div>
					...
					<input
						...
						onChange={(e) =>
							setIncidencia({ ...incidencia, titulo: e.target.value })
						}
				...
				<div className="grid grid-cols-2 gap-4">
					<div>
						...
						<select
							...
							onChange={(e) =>
								setIncidencia({ ...incidencia, tipo: e.target.value })
							}
							className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
							required
						>
					...
					<div>
						...
						<select
							...
							onChange={(e) =>
								setIncidencia({ ...incidencia, prioridad: e.target.value })
							}
							className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
							required
						>
				...
				<div>
					...
					<select
						...
						onChange={(e) =>
							setIncidencia({ ...incidencia, estado: e.target.value })
						}
						className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
						required
					>
				...
				<div>
					...
					<input
						...
						onChange={(e) =>
							setIncidencia({ ...incidencia, ubicacion: e.target.value })
						}
						className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
						required
					/>
				...
				<div>
					...
					<textarea
						...
						onChange={(e) =>
							setIncidencia({ ...incidencia, descripcion: e.target.value })
						}
						rows={3}
						className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
						required
				...
				<div>
					...
					<textarea
						...
						onChange={(e) =>
							setIncidencia({ ...incidencia, solucionAplicada: e.target.value })
						}
