	...
	const incidencias = [
		{
			...
			descripcion:
				"Fuga importante en la tubería principal que afecta el suministro",
		...
		},
		{
			...
			descripcion:
				"Varios usuarios reportan baja presión de agua en horario nocturno",
			solucion: null,
		},
		{
			id: 4,
			...
			<div className="flex items-center gap-4 mb-6">
				...
				<div>
					...
					<p className="text-gray-600">
						Historial de incidencias reportadas y su resolución
					</p>
				</div>
			</div>
								...
								<div className="flex-1">
									...
									<div className="grid grid-cols-1 gap-2 text-sm text-gray-600 mb-3">
										...
										<div className="flex items-center gap-2">
											...
											<span>
												{item.reportadoPor} ({item.telefono})
											</span>
										</div>
									</div>
				...
				<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
					<div className="bg-white rounded-lg p-6 max-w-sm mx-4">
						...
						<p className="text-gray-600 mb-4">
							¿Estás seguro de que quieres eliminar esta incidencia? Esta acción
