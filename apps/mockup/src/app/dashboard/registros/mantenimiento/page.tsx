	...
	const mantenimientos = [
		{
			...
			duracion: "4 horas",
			descripcion:
				"Limpieza completa del tanque, desinfección y revisión de válvulas",
		...
		},
		{
			...
			duracion: "3 horas",
			descripcion:
				"Revisión general de bombas, cambio de aceite y verificación de presiones",
			observaciones:
				"Bomba principal requiere cambio de rodamientos en próxima revisión",
		...
		},
		{
			...
			duracion: "6 horas",
			descripcion:
				"Reparación de fuga en tubería principal y reemplazo de sección dañada",
								...
								<div className="flex-1">
									<div className="mb-2">
										<div className="flex gap-2 mb-2">
											...
											<span
												className={`px-2 py-1 rounded-full text-xs font-medium ${getTipoColor(item.tipo)}`}
											>
												{item.tipo}
											</span>
										</div>
