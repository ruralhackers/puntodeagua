			...
			<div className="flex items-center gap-4 mb-6">
				...
				<div>
					...
					<p className="text-gray-600">
						Gestión de pozos, tanques y red de distribución
					</p>
				</div>
			</div>
						...
						<div className="flex items-start justify-between">
							<div className="flex items-start gap-3 flex-1">
								...
								<div className="flex-1">
									<div className="mb-2">
										<span
											className={`px-2 py-1 rounded-full text-xs font-medium ${getEstadoColor(punto.estado)} mb-2 inline-block`}
										>
											{punto.estado}
										</span>
				...
				<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
					<div className="bg-white rounded-lg p-6 max-w-sm mx-4">
						...
						<p className="text-gray-600 mb-4">
							¿Estás seguro de que quieres eliminar este punto de agua? Esta
