		...
		completadas: [
			{
				...
				fecha: "2023-06-15",
				tipo: "análisis",
				completada: "2023-06-15",
			},
			{
				id: 6,
				titulo: "Reparación de fuga menor",
				fecha: "2023-06-10",
				tipo: "reparación",
				completada: "2023-06-12",
			},
		],
	};
										...
										<div className="flex justify-between items-start mb-2">
											...
											<div className="flex gap-2">
												<Button variant="outline" size="sm" asChild>
													<Link
														href={`/dashboard/nuevo-registro?tipo=${tarea.tipo}&tarea=${tarea.id}`}
													>
														Registrar
													</Link>
												</Button>
				...
				<TabsContent value="programadas" className="mt-4">
					<Card>
						<CardHeader>
							...
							<CardDescription>Próximas tareas a realizar</CardDescription>
						</CardHeader>
						<CardContent>
							<div className="space-y-4">
				...
				<TabsContent value="completadas" className="mt-4">
					<Card>
						<CardHeader>
							...
							<CardDescription>Historial de tareas finalizadas</CardDescription>
						</CardHeader>
						<CardContent>
							<div className="space-y-4">
