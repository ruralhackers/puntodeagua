					...
					<div className="bg-white rounded-lg border border-gray-200 p-4 shadow">
						<div className="flex items-center justify-between mb-3">
							...
							<span className="text-sm text-gray-500">
								{elementosAtencion.length} elementos
							</span>
						</div>
								...
								<div
									...
									onClick={() => {
										if (elemento.tipo === "incidencia") {
											router.push(
												`/dashboard/incidencias/${elemento.id}/editar`,
											);
										} else {
									...
									<div className="flex items-start justify-between">
										<div className="flex-1">
											...
											<p className="text-xs text-gray-600 mt-1">
												{elemento.tipo === "incidencia"
													? "ubicacion" in elemento
														? elemento.ubicacion
														: ""
													: "fechaVencimiento" in elemento
														? `Vencía: ${elemento.fechaVencimiento}`
														: ""}
											</p>
										</div>
										...
										return (
											...
											>
												<div className="flex items-start justify-between">
													...
													<span
														className={`px-2 py-1 text-xs rounded-full font-medium ${getTipoColor(tarea.tipo)}`}
													>
														{tarea.tipo}
													</span>
												</div>
