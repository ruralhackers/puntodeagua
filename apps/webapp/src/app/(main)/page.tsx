        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <Link href="/analysis/new" className="group">
            <Card className="h-32 cursor-pointer transition-all duration-200 hover:shadow-md hover:scale-[1.02] bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200 hover:border-blue-300">
              <CardContent className="flex items-center justify-center h-full p-6">
                <div className="flex flex-col items-center gap-3 text-center">
                  <FlaskConical className="h-8 w-8 text-blue-600 group-hover:scale-110 transition-transform" />
                  <div>
          ...
          <Card className="h-32 bg-gradient-to-br from-gray-50 to-gray-100 border-gray-200 opacity-60 relative">
            <CardContent className="flex items-center justify-center h-full p-6">
              <div className="flex flex-col items-center gap-3 text-center">
                <Wrench className="h-8 w-8 text-gray-400" />
                <div>
                  <CardTitle className="text-gray-500 text-sm font-semibold">
          ...
          <Link href="/incident/new" className="group">
            <Card className="h-32 cursor-pointer transition-all duration-200 hover:shadow-md hover:scale-[1.02] bg-gradient-to-br from-orange-50 to-orange-100 border-orange-200 hover:border-orange-300">
              <CardContent className="flex items-center justify-center h-full p-6">
                <div className="flex flex-col items-center gap-3 text-center">
                  <AlertTriangle className="h-8 w-8 text-orange-600 group-hover:scale-110 transition-transform" />
                  <div>
                    <CardTitle className="text-orange-800 text-sm font-semibold">
                      Registrar Incidencia
                    </CardTitle>
                    <CardDescription className="text-orange-600 text-xs mt-1">
                      Problemas y alertas
                    </CardDescription>
                  </div>
                </div>
