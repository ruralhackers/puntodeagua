...
import { Mail, MoreVertical, Phone, Plus, Search, User } from 'lucide-react'
...
import { useAuthHttpClient } from '@/src/features/auth/hooks/use-auth-http-client'
...
export default function UsuariosPage() {
  ...
  const fetchUsers = useCallback(async () => {
    try {
      setIsLoading(true)
      const response = await authHttpClient.get<UsersResponse>('/users')
      if (!response.data) {
  ...
  useEffect(() => {
    ...
    fetchUsers()
  }, [authLoading, hasAccess, fetchUsers, router])
