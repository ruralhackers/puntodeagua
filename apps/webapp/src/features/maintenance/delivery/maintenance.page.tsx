...
export const MaintenanceDetailPage: FC<MaintenanceDetailProps> = ({ maintenance, waterZone }) => {
...
function getStatus(executionDate?: Date, scheduledDate?: Date): { label: string; classes: string } {
  if (executionDate) return { label: 'Completado', classes: 'bg-green-100 text-green-800' }
